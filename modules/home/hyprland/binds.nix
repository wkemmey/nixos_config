...
in {
  wayland.windowManager.hyprland.settings = {
    bind = [
      ...
      "$modifier SHIFT,N,exec,gtk-launch dev.heppen.webapps.Mimiri8495"
      "$modifier SHIFT,M,exec,gtk-launch dev.heppen.webapps.Messages4146"
      "$modifier,J,exec,gtk-launch dev.heppen.webapps.JitsiMeet9763"
      "$modifier CTRL,M,exec,appimage-run ./Moonlight-6.1.0-x86_64.AppImage stream 192.168.86.52:47989 Desktop"
